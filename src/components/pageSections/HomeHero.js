    ...
    {/*>*/}
      <div className="hero-content has-overlay-dark hero-image-1">
        <Container>
          <Row>
            <Col lg={8}>
              <h1>Empowering Research<br />At Scale</h1>
              ...
              <div className="CTAs">
                <a href="https://account.beocat.ksu.edu/" className="btn btn-primary">Get an Account</a>
                <a href="https://support.beocat.ksu.edu/" className="btn btn-outline-light">Support</a>
              </div>
            </Col>
          </Row>
        </Container>
