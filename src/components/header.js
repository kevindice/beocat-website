          ...
          <div className="navbar-nav ml-auto">
            ...
            <div className="nav-item dropdown">
              <a
                ...
                className="nav-link"
              >
                Dropdown <i className="fa fa-angle-down" />
              </a>
              <ul
              ...
              >
                ...
                <li className="dropdown-submenu">
                  <a
                    ...
                    className="nav-link"
                  >
                    Dropdown link <i className="fa fa-angle-down" />
                  </a>
                  <ul
                  ...
                  >
                    ...
                    <li className="dropdown-submenu">
                      <a
                        ...
                        className="nav-link"
                      >
                        Another action <i className="fa fa-angle-down" />
                      </a>
                      <ul
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-lg-3">
                      <strong className="text-uppercase">Main</strong>
                      <ul className="list-unstyled">
                        ...
                        <li>
                          <a href="courses-2.html">Courses - table</a>
                        </li>
                        <li>
                    ...
                    <div className="col-lg-3">
                      <strong className="text-uppercase">Blog & text</strong>
                      <ul className="list-unstyled">
                        <li>
                        ...
                        <li>
                          <a href="staff-detail.html">Staff detail </a>
                        </li>
                      </ul>
                    </div>
                    <div className="col-lg-3">
                      <strong className="text-uppercase">Just demo </strong>
                      <ul className="list-unstyled">
                        <li>
                          <a href="#">Demo</a>
                        </li>
